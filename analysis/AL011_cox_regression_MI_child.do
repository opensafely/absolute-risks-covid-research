********************************************************************************
*
*	Do-file:		AL011_cox_regression_MI_child.do
*
*	Programmed by:	Fizz & Krishnan & John
*
*	Data used:		analysis/
*							data_ldanalysis_cohort1_MI_child.dta
*							data_ldanalysis_cohort2MI_child.dta
*
*	Data created:	None
*
*	Other output:	Log file:  logs/AL011_cox_regression_MI_child.log
*					Estimates:	output/
*									ldcox_covidadmission_child_mi.out
*
********************************************************************************
*
...
* Open a log file
cap log close
log using "logs/AL011_cox_regression_MI_child", replace t
...
* Save data
outsheet using "output/ldcox_covidadmission_child_mi.out", replace
