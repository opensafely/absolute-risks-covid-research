********************************************************************************
*
*	Do-file:		AL002_tabulate_cohort_descriptives_nonCC.do
*
...
*	Data created:	None
*
*	Other output:	Table: 		output/basetable1_all.txt
*					Log file: 	logs/AL002_tabulate_cohort_descriptives_nonCC.log
*
********************************************************************************
*
*	Purpose:		This do-file describes the data in the base cohort and 
*					puts the output in a log file in the whole sample
*					(not restricting to complete case ethnicity).
*  
********************************************************************************* 
...
* Open a log file
cap log close
log using "logs/AL002_tabulate_cohort_descriptives_nonCC", text replace 
...
file open tablecontent using "output/basetable1_all.txt", write text replace
...
tabulatevariable, variable(ethnicity_5) start(1) end(5) file(tablecontent) binexp(ldr) missing
file write tablecontent _n 
