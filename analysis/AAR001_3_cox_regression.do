********************************************************************************
*
*	Do-file:		AAR001_3_cox_regression.do
*
...
*	Data created:	None
*
*	Other output:	Log file:  logs/AAR001_3_cox_regression.log
*					Estimates:	output/
*									hr_coviddeath_wave1_male0.txt
*									hr_coviddeath_wave1_male1.txt
*
********************************************************************************
*
...
* Open a log file
cap log close
log using "logs/AAR001_3_cox_regression", replace t
...
forvalues j = 0 (1) 1 {
	...
	stcox 		age1 age2 age3					///
				...
				if male==`j'					///
				, strata(stp)
	estimates save coefs_cox_3_`j', replace
}
...
forvalues j = 0 (1) 1 {
	* Cox model
	crtablehr, 	estimates(coefs_cox_3_`j')		///
