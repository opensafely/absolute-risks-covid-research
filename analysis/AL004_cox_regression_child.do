********************************************************************************
*
*	Do-file:		AL004_cox_regression_child.do
*
...
*	Data created:	None
*
*	Other output:	Log file:  logs/AL004_cox_regression_child.log
*					Estimates:	output/
*									output_hrs_main_child
*									output/output_rates_child
*
********************************************************************************
*
...
* Open a log file
cap log close
log using "logs/AL004_cox_regression_child", replace t
