********************************************************************************
*
*	Do-file:		AL006a_cox_regression_interactions_age.do
*
...
* Open a log file
cap log close
log using "logs/AL006a_cox_regression_inter_age_wave`i'_`out'_`exp'", replace t
...
* Save data
outsheet using "output/ldcox_inter_age_wave`i'_`out'_`exp'", replace
