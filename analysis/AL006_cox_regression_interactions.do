********************************************************************************
*
*	Do-file:		AL006_cox_regression_interactions.do
*
...
*	Data created:	None
*
*	Other output:	Log file:  logs/AL006_cox_regression_inter_wave`i'_`out'_`exp'.log
*					Estimates:	output/
*									ldcox_inter_wave`i'_`out'_`exp'.out
*
* 						i = Wave (1 or 2)
...
* Open a log file
cap log close
log using "logs/AL006_cox_regression_inter_wave`i'_`out'_`exp'", replace t
